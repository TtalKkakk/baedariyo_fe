...
const VEHICLE_TYPES = [
  ...
  { value: 'E_BICYCLE', label: '전기자전거' },
  { value: 'E_SCOOTER', label: '전동 킥보드' },
  ...
  return (
    <div className="min-h-full bg-white px-4 py-6">
      ...
      <p className="mt-1 text-body2 text-[var(--color-semantic-label-alternative)]">
        가입 완료 후 배달원 로그인으로 인증 토큰을 발급해 주세요.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-5 space-y-3">
        ...
        >
          {signupMutation.isPending ? '가입 요청 중...' : '배달원 회원가입'}
        </button>
      </form>
